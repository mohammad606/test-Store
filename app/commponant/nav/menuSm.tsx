...
const MenuSm = ({show}:{show:boolean})=>{
    ...
    return (
        <>
            ...
            <div className='flex flex-row w-full px-8 dd:px-5'>
                <Link href="/pages/allProducts" className={path == '/pages/allProducts' ? 'border-b-2 border-blue-600 pb-1 hover:border-red-600':'hover:border-red-600 hover:pb-1 hover:border-b-2'}
                      style={show?{width:'100%',display:'flex',justifyContent:'space-between',padding:'5px 15px'}:{}}>
